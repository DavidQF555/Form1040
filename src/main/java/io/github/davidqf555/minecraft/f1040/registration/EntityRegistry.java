...
public final class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<ShadyBankerEntity>> SHADY_BANKER = register("shady_banker", ShadyBankerEntity::new, EntityClassification.MISC, 0.6f, 1.95f);
    ...
    public static void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
        ...
        event.put(SHADY_BANKER.get(), VillagerEntity.createAttributes().build());
    }
